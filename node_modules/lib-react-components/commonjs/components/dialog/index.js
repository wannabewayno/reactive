...
var Dialog = function (_PureComponent) {
  ...
  _createClass(Dialog, [{
    ...
    value: function renderCancelButton() {
      ...
      return cancelText && _react2.default.createElement(
        _button2.default,
        _extends({
          size: 'small',
          className: s.button,
    ...
    value: function renderAcceptButton() {
      ...
      return acceptText && _react2.default.createElement(
        _button2.default,
        _extends({
          primary: true,
          size: 'small',
    ...
    value: function renderButtons() {
      ...
      return (acceptText || cancelText) && _react2.default.createElement(
        'div',
        { className: s.buttons },
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        _extends({
          className: (0, _classnames2.default)(s.c_dialog_wrapper, className, _defineProperty({}, s.m_smooth, smooth))
        }, other),
        _react2.default.createElement('div', {
          className: (0, _classnames2.default)(s.overlay, classNameOverlay),
          onClick: onClose
        }),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              className: (0, _classnames2.default)(s.dialog, classNameDialog)
            },
            title && _react2.default.createElement(
              'h3',
              { className: (0, _classnames2.default)(s.title, 'break_word') },
              title
            ),
            _react2.default.createElement(
              'div',
...
Dialog.propTypes = {
   ...
   */
  title: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string, _propTypes2.default.node]),
  /**
   * The contents of the Dialog
   */
  children: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string, _propTypes2.default.node]),
  /**
   * The value to display on the Dialog cancel button. Could be number, string, element
   * or an array containing these types
   */
  cancelText: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string, _propTypes2.default.node]),
  /**
   * The cancel button props
   */
  cancelButtonProps: _propTypes2.default.oneOfType([_propTypes2.default.object]),
  /**
   * The value to display on the Dialog accept button. Could be number, string, element
   * or an array containing these types
   */
  acceptText: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string, _propTypes2.default.node]),
  /**
   * The accept button props
   */
  acceptButtonProps: _propTypes2.default.oneOfType([_propTypes2.default.object]),
  /**
   * If set to true, Dialog buttons will turn over
   */
  swapButtons: _propTypes2.default.bool,
  /**
   ...
   */
  classNameDialog: _propTypes2.default.string,
