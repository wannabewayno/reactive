...
var _required = require('../icons/required');
...
var Input = function (_PureComponent) {
  ...
  _createClass(Input, [{
    ...
    value: function _renderRequiredIcon() {
      ...
      return required && _react2.default.createElement(_required2.default, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Component, _extends({
          ...
          className: (0, _classnames2.default)('input_field', 'round_small', ['input_field_' + size], ['stroke_' + color], (_classNames = {
