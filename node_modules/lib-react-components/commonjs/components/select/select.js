...
var _select_dropdown = require('./select_dropdown');

var _select_dropdown2 = _interopRequireDefault(_select_dropdown);

var _analytics_hoc = require('../../containers/analytics_hoc');

var _analytics_hoc2 = _interopRequireDefault(_analytics_hoc);

var _select_arrow = require('../icons/select_arrow');

var _select_arrow2 = _interopRequireDefault(_select_arrow);
  ...
  _createClass(Select, [{
    ...
    value: function _renderOpenButton() {
      ...
      return _react2.default.createElement(
        ...
        arrowComponent || _react2.default.createElement(_select_arrow2.default, { className: 'select_arrow_icon' })
      );
    }
    ...
    value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _extends({
              ...
              tabIndex: tabIndex,
              multiple: false,
              className: (0, _classnames2.default)('select_field', 'round_small', ['select_field_' + size], ['select_field_focus_' + colorFocus], ['stroke_' + color], (_classNames = {}, _defineProperty(_classNames, 'fill_' + color, bgType === 'fill'), _defineProperty(_classNames, 'fill_white', bgType === 'stroke'), _classNames)),
              name: name,
              disabled: disabled,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            'data-component': 'select_field',
            className: (0, _classnames2.default)('select_field', 'truncate_text', 'round_small', ['select_field_' + size], ['select_field_focus_' + colorFocus], ['stroke_' + color], (_classNames2 = {}, _defineProperty(_classNames2, 'fill_' + color, bgType === 'fill'), _defineProperty(_classNames2, 'fill_white', bgType === 'stroke'), _classNames2)),
            onClick: this._handleClick
          },
          _react2.default.createElement(
            'span',
            {
              className: (0, _classnames2.default)((_classNames3 = {}, _defineProperty(_classNames3, 'text_' + textColor, valueState), _defineProperty(_classNames3, 'text_' + placeholderColor, !valueState), _classNames3))
            },
            displayValue
          )
        ),
        ...
        this._renderOpenButton(),
        options && options.length > 0 && _react2.default.createElement(
          _select_dropdown2.default,
          {
...
Select.propTypes = {
  ...
  arrowComponent: _propTypes2.default.node,
  /**
   ...
   */
  mobileSize: _propTypes2.default.oneOf(['medium', 'large']),
  /**
...
exports.default = (0, _analytics_hoc2.default)(Select, 'onChange');
