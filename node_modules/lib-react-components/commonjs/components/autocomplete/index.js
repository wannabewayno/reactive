...
var _select_dropdown = require('../select/select_dropdown');
...
function validationPropType(props, propName, componentName) {
  ...
  if (typeof value === 'string') {
    var _error = _propTypes2.default.oneOf(['password', 'fullName', 'email', 'phone', 'number', 'text', 'letters', 'date', 'cert', 'hex', 'base64', 'objectID', 'url']).apply(undefined, [props, propName, componentName].concat(rest));
  ...
  var error = _propTypes2.default.func.apply(_propTypes2.default, [props, propName, componentName].concat(rest));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _extends({
          ...
          className: (0, _classnames2.default)('autocomplete', className)
        }, other),
        _react2.default.createElement(_text_field2.default, {
...
Autocomplete.propTypes = {
   ...
   */
  type: _propTypes2.default.oneOf(['text', 'password', 'email', 'tel', 'date']),
  /**
   ...
   */
  validation: _propTypes2.default.arrayOf(validationPropType)
};
