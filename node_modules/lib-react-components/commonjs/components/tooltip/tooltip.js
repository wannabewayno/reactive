...
var _tooltip_popper = require('./tooltip_popper');

var _tooltip_popper2 = _interopRequireDefault(_tooltip_popper);

var _portal = require('../../containers/portal');
...
var Tooltip = function (_Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function onDocumentClick(e) {
      ...
      var root = (0, _reactDom.findDOMNode)(this.parentNode); // eslint-disable-line
      ...
      if (overlay && action === 'click') {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement('div', _extends({
            'data-open': open,
            className: (0, _classnames2.default)('tooltip_overlay', 'fill_' + overlayColor, className),
            style: _extends({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.cloneElement(children, newChildProps),
          _react2.default.createElement(
            _tooltip_popper2.default,
            {
              open: open,
...
Tooltip.propTypes = {
   ...
   */
  action: _propTypes2.default.oneOf(['click', 'hover', 'focus', 'none']),
  /**
   ...
   */
  open: _propTypes2.default.bool, // eslint-disable-line
  /**
   ...
   */
  overlayZIndex: _propTypes2.default.number,
  /**
   * HTML props for tooltip overlay.
   */
  overlayProps: _propTypes2.default.oneOfType([_propTypes2.default.object]),
  /**
   * Use React portal for render tooltip to another elemenet.
   */
  usePortal: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.instanceOf(HTMLElement)]),
  /**
   ...
   */
  preventFlip: _propTypes2.default.bool,
  /**
   * Class name for tooltip popper root element
   */
  classNameTooltip: _propTypes2.default.string,
  /**
   * Class name for tooltip popper content element
   */
  classNameTooltipContent: _propTypes2.default.string,
  /**
   ...
   */
  flipBoundaryElement: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.instanceOf(HTMLElement)])
};
