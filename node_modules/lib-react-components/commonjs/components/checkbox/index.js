    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _extends({
          ...
          className: (0, _classnames8.default)('checkbox', className)
        }, other),
        ...
        _react2.default.createElement(
          'div',
          {
            className: (0, _classnames8.default)('checkbox_container', (_classnames = {}, _defineProperty(_classnames, 'stroke_' + color, !checkedState), _defineProperty(_classnames, 'fill_' + color, !checkedState), _classnames), (_classnames2 = {}, _defineProperty(_classnames2, 'stroke_' + colorOn, checkedState), _defineProperty(_classnames2, 'fill_' + colorOn, checkedState), _classnames2)),
            'data-component': 'checkbox_container'
          },
          iconType === 'square' ? _react2.default.createElement('div', {
            className: (0, _classnames8.default)('checkbox_icon_square', _defineProperty({}, 'fill_' + iconColor, !checkedState), _defineProperty({}, 'fill_' + iconColorOn, checkedState))
          }) : _react2.default.createElement(_checkmark2.default, {
            className: (0, _classnames8.default)('checkbox_icon_checkmark', _defineProperty({}, 'fill_' + iconColor, !checkedState), _defineProperty({}, 'fill_' + iconColorOn, checkedState))
          })
        ),
...
Checkbox.propTypes = _extends({}, _switch_handler2.default.propTypes, {
  iconType: _propTypes2.default.string
});
Checkbox.defaultProps = _extends({}, _switch_handler2.default.defaultProps, {
  iconType: 'checkmark'
});
exports.default = (0, _analytics_hoc2.default)(Checkbox, 'onCheck');
