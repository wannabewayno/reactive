...
var emotionsСharacterRanges = '\xA9\xAE\u2000-\u3300\uD83C\uD000-\uDFFF\uD83D\uD000-\uDFFF\uD83E\uD000-\uDFFF';
...
var allowedNameСharacter = "'";
var nameRegExp = new RegExp('^(([^' + nonLetterСharacter + emotionsСharacterRanges + '\\s]|' + allowedNameСharacter + ')+(\\s|-))*([^' + nonLetterСharacter + emotionsСharacterRanges + '\\s]|' + allowedNameСharacter + ')+$', 'i');
var lettersRegExp = new RegExp('^([^' + nonLetterСharacter + emotionsСharacterRanges + '\\s\'])+$', 'i');
...
//# sourceMappingURL=reg_exps.js.map