...
export default function Avatar(props) {
  var letters = props.letters,
      ...
      other = _objectWithoutProperties(props, ['letters', 'className', 'size', 'src', 'defaultSrc', 'style', 'bgType', 'color', 'textColor', 'onError']);
  ...
  if (letters && !src) {
    ...
    return React.createElement(
      ...
      _extends({
        ...
        className: classNames('avatar', 'round_circle', 'truncate_text', _defineProperty({}, 'fill_' + color, bgType === 'fill'), ['stroke_' + color], ['text_' + textColor], className),
  ...
  return React.createElement('img', _extends({
    'data-component': 'avatar',
    src: src || defaultSrc,
    className: classNames('avatar', 'round_circle', _defineProperty({}, 'fill_' + color, color), className),
    style: _extends({}, style, {
      height: size,
      width: size
    }),
