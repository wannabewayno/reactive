...
function minMaxPropType(props, propName, componentName) {
  ...
  var error = PropTypes.number.apply(PropTypes, [props, propName, componentName].concat(rest));
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement('div', {
          ...
          className: classNames('slider_track', ['fill_' + color])
        }),
        React.createElement('div', {
          className: classNames('slider_progress', ['fill_' + (progressColor || color)]),
          style: {
            width: percent + '%'
          },
        ...
        React.createElement('div', {
          className: classNames('slider_tab', ['fill_' + iconColor]),
          style: {
            left: percent + '%'
          }
        }),
