    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          {
            className: classNames('radio_container', (_classNames = {}, _defineProperty(_classNames, 'stroke_' + colorOn, checked), _defineProperty(_classNames, 'fill_' + colorOn, checked), _classNames), (_classNames2 = {}, _defineProperty(_classNames2, 'stroke_' + color, !checked), _defineProperty(_classNames2, 'fill_' + color, !checked), _classNames2)),
            'data-component': 'radio_container'
          },
          React.createElement('div', {
            className: classNames('radio_tumbler', _defineProperty({}, 'fill_' + iconColor, !checked), _defineProperty({}, 'fill_' + iconColorOn, checked))
          })
        ),
