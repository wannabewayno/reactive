    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        _extends({
          ...
          className: classNames('select_dropdown', ['stroke_' + colorFocus], (_classNames = {}, _defineProperty(_classNames, 'fill_' + color, bgType === 'fill'), _defineProperty(_classNames, 'fill_white', bgType === 'stroke'), _classNames), 'round_small', className),
